...
/**
 * @file
 * Contains \Drupal\csvimport\Form\CsvimportImportForm.
 */
...
class CsvimportImportForm extends FormBase {
  ...
  public function buildForm(array $form, \Drupal\Core\Form\FormStateInterface $form_state) {
    $form['notes'] = [
      '#type' => 'markup',
      '#markup' => '<div class="import-notes">A few notes when Importing. <ul><li>Make sure the file is in a .csv format.</li><li>Be sure to click the "Import" button when you select a csv.</li></ul></div>',
